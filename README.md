...
Live examples contact public TAP services. Default CI omits them because remote
availability, rate limits, and network conditions are outside this
...
failure recovery against public TAP services.
...
that representative tools, prompts, and resources are discoverable without
querying a remote TAP service.
